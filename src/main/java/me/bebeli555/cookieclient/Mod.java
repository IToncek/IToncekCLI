...
public class Mod {
	public static final String MODID = "itoncekcli";
	public static final String NAME = "IToncekCLI";
	...
	public static ArrayList<Mod> modules = new ArrayList<>();
